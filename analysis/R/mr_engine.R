...
summarise_suite <- function(suite, trait, presso_nb) {
  ...
  global_p <- outlier_n <- distortion_p <- raw_b <- raw_p <- corrected_b <- corrected_p <- NA_real_
  ...
  data.table::data.table(
    ...
    presso_distortion_p = distortion_p, presso_raw_b = raw_b, presso_raw_p = raw_p,
    presso_corrected_b = corrected_b, presso_corrected_p = corrected_p,
